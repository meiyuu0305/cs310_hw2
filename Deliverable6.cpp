...
template<typename T>class DoublyLinkedList{
    ...
    public:
        ...
        /**
         * @brief the function searches for the value and record all of the indexes in a vactor 
         * @param searchVal - search variable
         * @return vector<int> - the vector that the function will return
         */
        vector<int> searchItems(T searchVal){
            ...
            for (int i = 0; i< count; i++){
                ...
                if (value == searchVal || value.compare(searchVal) == 0)
                {
                    indexes.push_back(i);
                }
...
int main(){
    ...
    city_names.push_front(3);
    city_names.push_front(1);
    city_names.push_front(2);
    city_names.push_front(6);
    city_names.push_front(2);
    city_names.displayList();
    int searchfor = 2;
    vector<int> match_indexes = city_names.searchItems(2);
    for( int x: match_indexes)
    {
        cout<< x << " ";
    }
    return 0; 
