...
template<typename T>class DoublyLinkedList{
    ...
    public:
        ...
        // bool insert(int index, T value); // insert value at a specific location
        ...
        //delete the tail node and return it 
        bool pop_back (T &d) {
            if(head != nullptr){
        ...
        // bool elementAt (int index, T& value); // accessing the information at index
        void displayList(){
            Node<T> * node = head;
            while(node != nullptr)
            {
...
int main(){
    ...
    city_names.push_front(7);
    city_names.push_front(9);
    cout << "Original list\t";
    city_names.displayList();
    cout << "Deleting node index 1\t";
    city_names.deleteNode(1); // deleting node at index 1, using optimal method
    city_names.displayList();
    cout << "\nDeleting node index 2\t";
    city_names.deleteNode(2);
    city_names.displayList();
 ...
 * @return false - unsccesful attempt
 */
template<typename T>
